...
local config = {
  ...
  settings = {
    java = {
      ...
      home = "/Users/brianseo/Library/Java/JavaVirtualMachines/openjdk-22.0.2/Contents/Home",
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          ...
          {
            name = "JavaSE-17",
            path = "/Users/brianseo/Library/Java/JavaVirtualMachines/corretto-17.0.12/Contents/Home",
          },
          -- {
          --   name = "JavaSE-19",
          ...
          {
            name = "JavaSE-22",
            path = "/Users/brianseo/Library/Java/JavaVirtualMachines/openjdk-22.0.2/Contents/Home",
          },
                  },
      },
      maven = {
